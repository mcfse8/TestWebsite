const axeContent = {
  ...
  quantification_exocamsh: {
    ...
    sections : [{
      text: `Nous avons étendus nos réflexions et travaux de développement de méthodes efficaces, capables d’exploiter de façon systématique des grandes quantités de mesures des sondeurs IASI ou S5P, à d’autres questions : approche pour identifier les épisodes de pollutions des villes à partir des produits de niveau 2 des sondeurs (notamment de S5P) ; méthodes de détection et de quantification des sources de polluants au sol à partir du sondeur spatial S5P. Ces travaux permettent de mettre en place des traitements et des produits qui visent à termes à alimenter des services de monitoring de la qualité de l’air et de soutien aux politiques environnementales. Ces travaux permettent également de mettre en évidence les limites des sondeurs atmosphériques et les recommandations/spécifications vers les futurs sondeurs pour la mesure des émissions de polluants depuis l’espace.`,
  ...
  concepts_exocamsh: {
    ...
    sections: [{
      text: `Nous avons initié en 2024 des travaux de recherche et développements contribuant à la préparation, par le CNES, d’un nouveau concept d’instrument original pour améliorer la mesure de la température et de la vapeur d’eau de l’atmosphère dans les basses couches : CMIM (Constellation de MIni sondeurs pour la Météorologie). Ce concept vise à fournir des mesures spatiales permettant d’améliorer encore les prévisions météorologiques à fine échelle, en proposant des solutions instrumentales pour diminuer le cout des missions. Cette année, SPASCIA mène une étude métier pour l’analyse de faisabilité de nouvelle méthode de sondage des profils de température et de vapeur d’eau dans l’infrarouge, qui contribue à la définition et au développement de CMIM.`,
      image: "../cmim.png",
      side : "left",
      imageCredit: {

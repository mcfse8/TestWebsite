...
function parseCSV(csvText) {
  ...
  const wantedHeaders = ["date", "latitude", "longitude", "Country/Sea", "Region", "DAY/NIGHT", "cluster_category", "cluster_indicators", "ndetection", "cluster_number", "point_indicators"];
